...
_A reference of available configurations in Metro._
...
[Tailwind CSS](https://docs.expo.dev/guides/tailwind/)
...
{/* If this isn't done, then features like [aliases](https://docs.expo.dev/guides/typescript/#path-aliases-optional), [absolute imports](https://docs.expo.dev/guides/typescript/#absolute-imports-optional), asset hashing, and more will not work. */}
