  ...
  describe("determinism", () => {
    it("should produce identical results for same data", async () => {
      ...
      setTripData({
        ...
        splits: {
          [expense1Id]: [
            { id: "det-s1", expenseId: expense1Id, participantId: p1, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
            { id: "det-s2", expenseId: expense1Id, participantId: p2, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
            { id: "det-s3", expenseId: expense1Id, participantId: p3, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
          ],
          [expense2Id]: [
            { id: "det-s4", expenseId: expense2Id, participantId: p1, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
            { id: "det-s5", expenseId: expense2Id, participantId: p2, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
            { id: "det-s6", expenseId: expense2Id, participantId: p3, share: 1, shareType: "equal", createdAt: now, updatedAt: now },
          ],
        },
      });
